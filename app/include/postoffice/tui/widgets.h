...
// Progress bar style structure
struct tui_progress_bar_style_t {
...
struct tui_progress_bar_t {
    ...
    struct tui_progress_bar_style_t style; /**< Progress bar style */
...
struct tui_menu_item_t {
    ...
    char shortcut;                  /**< Keyboard shortcut (0 for none) */
 ...
 */
void tui_button_set_click_callback(struct tui_button_t* button, tui_button_click_callback_t callback, void* user_data);
 ...
 * @param user_data User data to pass to the callback
 */
void tui_list_set_select_callback(struct tui_list_t* list, tui_list_select_callback_t callback, void* user_data);
 ...
 */
struct tui_progress_bar_t* tui_progress_bar_create(tui_rect_t bounds, float min_value, float max_value);
 ...
 */
void tui_progress_bar_set_style(struct tui_progress_bar_t* bar, const struct tui_progress_bar_style_t* style);
 ...
 */
int tui_tab_container_add_tab(struct tui_tab_container_t* tabs, const char* title, struct tui_widget_t* content);
 ...
 * @return true on success, false on failure
 */
bool tui_menu_add_item(struct tui_menu_t* menu, const char* label, const char* shortcut, tui_callback_t callback, void* user_data);
 ...
 */
char* tui_dialog_show_input(tui_window_t* parent, const char* title, const char* prompt, const char* default_text);
