...
#include "types.h"    // Includes tui_theme_t and tui_button_callback_t
...
void tui_window_set_close_callback(tui_window_t* window, tui_window_close_callback_t callback, void* user_data);
 ...
 * @return Selected file path (must be freed by caller), or NULL if cancelled
 */
char* tui_file_dialog_save(tui_window_t* parent, const char* title, const char* default_name, const char* filter);
 ...
 */
tui_button_t* tui_button_create(const char* text, tui_point_t pos, tui_size_t size, 
 ...
 */
void tui_widget_align(tui_widget_t* parent, tui_widget_t* child, 
 ...
 */
void tui_widget_fill_parent(tui_widget_t* parent, tui_widget_t* child, 
 ...
 */
void tui_window_register_shortcuts(tui_window_t* window, 
                                 const tui_shortcut_t* shortcuts, 
                                 size_t count);
