...
typedef void (*tui_checkbox_toggle_callback_t)(tui_checkbox_t *checkbox, bool checked,
                                               void *user_data);
typedef void (*tui_radio_button_select_callback_t)(tui_radio_button_t *radio, int selected_index,
                                                   void *user_data);
typedef void (*tui_combo_box_select_callback_t)(tui_combo_box_t *combo_box, int selected_index,
 ...
 */
typedef bool (*tui_event_callback_t)(tui_widget_t *widget, const tui_event_t *event,
                                     void *user_data);
